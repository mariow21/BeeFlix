  ...
  <body>
        <div class="container bg-light">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tv') }}">TV Show <span class="sr-only"></span></a>
                    </li>
                  </ul>
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                <a type="button" class="btn btn-secondary btn-dark txt-light">Kembali</a>
        ...
        <div class="container bg-light mt-5">
            <div class="container bg-white mt-4 py-3">
                <h1>Drama</h1>
                <div class="row">
                    @foreach ($drama as $dra)                                           
                        <div  class="col-md-3">
                            <div class="card" style="width=17rem">
                                <img  src={{ asset('/' . $dra->photo)}} class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h6 class="card-title d-flex justify-content-center">{{ $dra->title }}</h6>
                                </div>
                                <div class="bg-dark card-footer">
                                    <a type="Button" class="btn-dark d-flex justify-content-center txt-light" href="/details/{{ $dra->id }}"> Lihat Film</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="container bg-white mt-4 py-3">
                ...
                <div class="row">
                    @foreach ($kids as $kid)                                           
                        <div class="col-md-3">
                            <div class="card">
                                <img src={{ asset('/' . $kid->photo)}} class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h6 class="card-title d-flex justify-content-center">{{ $kid->title }}</h6>
                                </div>
                                <div class="bg-dark card-footer">
                                    <a type="Button" class="btn-dark d-flex justify-content-center txt-light" href="/details/{{ $kid->id }}"> Lihat Film</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
